...
<head>
    ...
    <!--[if lt IE 10]>
      ...
      <meta name="description" content="Telas em JSP" />
      <meta name="keywords" content="bootstrap, bootstrap admin template, admin theme, admin dashboard, dashboard template, admin template, responsive" /> <!-- TAGS SEO -->"
      <meta name="author" content="Gabriel Neves" />
      <!-- Favicon icon -->
      <link rel="icon" href="<%= request.getContextPath() %>/assets/images/favicon.ico" type="image/x-icon"> <!-- PARA NAO PERDER O CAMINHO DO PROJETO -->
    <!-- Google font-->
